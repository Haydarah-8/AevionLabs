...
const img = (file: string, alt: string): Img => ({ src: `/images/${file}`, alt });
...
export const HERO_IMAGES: Img[] = [
  ...
  img("hero-2.avif", "Macro view of a code editor, characters dissolved into bokeh"),
  ...
  img("hero-5.avif", "A phone lying on a concrete surface, screen glowing faintly"),
];

/* --- Standalone slots --- */
export const SITE_IMAGES = {
  homeIntro: img("home-intro.avif", "A desk monitor and keyboard lit by a single lamp"),
  homeAbout: img("home-about.avif", "A blade of hard light falling across a studio wall"),
  servicesHero: img("services-hero.avif", "A glass rod standing lit in a dark room"),
  servicesIntro: img("services-intro.avif", "A smooth black sculptural form on a pale backdrop"),
  aboutWide: img("about-wide.avif", "An empty concrete hall with a grid of square openings"),
...
export const PROJECT_IMAGES = {
  prism: {
    hero: img("prism-hero.avif", "Layered translucent panels receding into shadow"),
  ...
  baseplate: {
    hero: img("baseplate-hero.avif", "A grid of identical modules with one raised out of alignment"),
    one: img("baseplate-1.avif", "A black cube resting on a concrete surface"),
    two: img("baseplate-2.avif", "A glossy black organic form, half matte and half polished"),
    three: img("baseplate-3.avif", "An empty studio corner stacked with concrete blocks"),
    four: img("baseplate-4.avif", "A sculptural black form catching a single highlight"),
  ...
  folio: {
    hero: img("folio-hero.avif", "Printed page layouts pinned across a studio wall"),
    one: img("folio-1.avif", "Sheets of tracing paper overlapping on a light table"),
  ...
  orbit: {
    hero: img("orbit-hero.avif", "A phone and laptop side by side, screens glowing"),
    one: img("orbit-1.avif", "Close crop of a screen edge, interface shapes defocused"),
